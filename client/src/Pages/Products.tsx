            ...
            <main className="flex-1">
               ...
               <Loading />
                ...
                <div className="text-center py-16">
                  ...
                  <p className="text-sm text-app-text-light mb-4">Try Again ....</p>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:gris-cols-4 gap-4 xl:gap-8">
