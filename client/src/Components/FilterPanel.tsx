...
const FilterPanel = ({categories, category, minPrice, maxPrice, updateFilter, clearFilters, hasFilters} : any) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-semibold text-app-green mb-3">Categorie</h3>
      ...
      {hasFilters && (
        ...
        className="w-full py-2 text-sm text-app-error hover:bg-red-700 hover:text-white rounded-lg transition-colors font-medium">
          Clear All Filters
        </button>
      )}
