        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16 gap-4">
            ...
            <div className="w-full flex items-center justify-end gap-4 lg:gap-10 ">
                ...
                <div className="flex items-center gap-3 ">
                    {/* Cart  */}
                    <button className="relative p-2 rounded-xl" onClick={() => setCartCount(true)}>
                        <ShoppingCartIcon className="size-5 text-zinc-900" />
                        {cartCount > 0 && <span className="absolute -top-1 -right-1 size-4 bg-red-700 text-white text-[10px] rounded-full flex-center">{cartCount}</span>}
                    </button>
                    ...
                    <div className="">
                        {user ? (
                            ...
                            <div className="flex-center gap-2">
                                ...
                                <Link to='/login' className="hidden md:flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-950 rounded-full hover:bg-green-800-light transition-colors">
                                  <UserIcon /> Login
                                </Link>
