import { ArrowRightIcon, ChartBarStacked, LeafIcon } from "lucide-react"
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 w-full">
            <div className="max-w-xl xl:pl-10">
                ...
                <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl text-white leading-tight mb-5">
                    Nourish your home with <span className="text-orange-400 text-5xl">EARTH's FINEST...</span>
                ...
                <div className="flex flex-wrap gap-3">
                    <Link to={'/products'} className="px-7 py-3 bg-orange-500 text-white font-semibold transition-all rounded-full hover:bg-orange-600 flex-center gap-2 active:scale-[0.98]">
                      Shop Now  <ArrowRightIcon className="size-4"/>
                    </Link>

                    <Link to={'/products'} className="px-7 py-3 bg-white/10 text-white font-semibold rounded-full hover:bg-white/20 transistion-all border border-white/20 flex-center gap-2  ">
                      Browse Categories <ChartBarStacked className="size-4"/> 
                    </Link>
                </div>
            </div>
